...
The build system creates (and publishes) snapshot releases by default, but you
can build a specific release type by setting the `RELEASE_TYPE` make variable.
For example:
